...
function pickup(payload) {
    return payload;
        ...
        setInterval(() => {
            ...
            hostConnection.emit('create', { event:'New Pickup', time: Date(Date.now), payload: { store: store_Num, store_Name: storeName, order_ID: orderNum, customer: customerName, address: customerAddress }});
        }, 7000);  
